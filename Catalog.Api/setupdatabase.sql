...
INSERT INTO dbo.Product (ProductGuid, ProductName, Description, ImageUrl, Price, CategoryName, Stock) VALUES (
...
AS
BEGIN
    INSERT INTO dbo.Product (ProductGuid, ProductName, Description, ImageUrl, Price, CategoryName, Stock)
    VALUES (
         @ProductGuid,
         @ProductName,
         @Description,
